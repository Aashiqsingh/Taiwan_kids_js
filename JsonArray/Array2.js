...
var findColor = products.filter((prod)=> prod.color.includes("white"))
console.log(findColor);




// reduce : to get the sum of all prices and it will return only single value
...
// var x = products.filter((prod)=> prod.category == "Mobile")
// console.log(x);
