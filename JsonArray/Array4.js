var company = [
  ...
  // q1
  // const moreThen80000 = company.map((comp)=> comp.employees.filter((emp)=> emp.salary > 80000))
  // console.log(moreThen80000);

  // q2

  // var totalEmp = company.reduce((sum,comp)=> sum + comp.employees.length,0)
  // console.log(totalEmp);

  // q3
  // var findName = company.find((comp)=> comp.employees.find((emp)=> emp.name === "Emily Davis")).employees.find((emp)=> emp.name === "Emily Davis").position
